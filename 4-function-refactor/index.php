...
/* Consider improvements we'd like to make:
 * 1. Change size of board (Connect 4?)
 * 2. Change win conditions (e.g. allow wrapping-around-the-edge?)
 * 3. Change storage (support sharing links to certain games)
 * 4. Change input/output format (e.g. JSON, for max API)
 * 5. Change rules: e.g. introduce a Joker card
 * 6. How would we approach converting this to three dimensions?
 *    Probably be easiest to start from scratch with no shared code?
 */